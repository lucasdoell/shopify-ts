  ...
  return (
    <div className="my-48 mx-auto max-w-7xl px-4 sm:mt-24 md:mt-72 text-center">
      ...
      <div className="mt-5 max-w-md mx-auto flex justify-center items-center md:mt-8">
        <Link
          href="#products"
          className="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium py-3
        ...
        <Link
          href="#"
          className="inline-flex items-center font-semibold text-gray-900 dark:text-gray-100 hover:text-gray-800 dark:hover:text-gray-400"
        >
          Learn More
        </Link>
      </div>
